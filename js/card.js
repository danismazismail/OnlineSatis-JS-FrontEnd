...
$(document).on("click", "#orderButton", function () {
  try {
    ...
    let selectedValue = sessionStorage.getItem("selectedValue");
    ...
    $.ajax({
      url: "http://localhost:5198/api/Order/CreateOrder",
      type: "POST",
      dataType: "json",
    ...
    // const response = fetch("http://localhost:5198/api/Order/CreateOrder", {
    //   method: "POST",
    //   headers: {
    ...
    // }
    // const data = response.json(); // JSON yanıtını bekle
